...
CatFramelessDialog::CatFramelessDialog(QWidget *parent)
{
    padding = 8;
    moveEnable = true;
    resizeEnable = true;
    ...
    //设置背景透明 官方在5.3以后才彻底修复
    // WA_TranslucentBackground+FramelessWindowHint 并存不绘制的BUG
...
void CatFramelessDialog::showEvent(QShowEvent *event)
{
...
void CatFramelessDialog::doWindowStateChange(QEvent *event)
{
    //非最大化才能移动和拖动大小
...
void CatFramelessDialog::doResizeEvent(QEvent *event)
{
...
bool CatFramelessDialog::eventFilter(QObject *watched, QEvent *event)
{
    if (watched == this) {
...
bool CatFramelessDialog::nativeEvent(const QByteArray &eventType, void *message, qintptr *result)
#else
bool CatFramelessDialog::nativeEvent(const QByteArray &eventType, void *message, long *result)
#endif
{
...
#ifdef Q_OS_WIN
bool CatFramelessDialog::winEvent(MSG *message, long *result)
{
...
void CatFramelessDialog::setPadding(int padding)
{
    this->padding = padding;
}

void CatFramelessDialog::setMoveEnable(bool moveEnable)
{
    this->moveEnable = moveEnable;
}

void CatFramelessDialog::setResizeEnable(bool resizeEnable)
{
    this->resizeEnable = resizeEnable;
}

void CatFramelessDialog::setTitleBar(QWidget *titleBar)
{
