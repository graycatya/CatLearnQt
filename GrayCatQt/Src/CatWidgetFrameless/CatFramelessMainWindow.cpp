...
#ifdef Q_OS_WIN
bool CatFramelessMainWindow::winEvent(MSG *message, long *result);
{
...
void CatFramelessMainWindow::setPadding(int padding)
{
    this->padding = padding;
}

void CatFramelessMainWindow::setMoveEnable(bool moveEnable)
{
    this->moveEnable = moveEnable;
}

void CatFramelessMainWindow::setResizeEnable(bool resizeEnable)
{
    this->resizeEnable = resizeEnable;
}

void CatFramelessMainWindow::setTitleBar(QWidget *titleBar)
{
